			...
			<div class="container">
				...
				<div class="row">
					...
					<div id="aside" class="col-md-3">
						<!-- aside Widget -->
						<form action="{{route('client.storelaptop')}}">
						<div class="aside">
								@csrf
					...
					<div id="store" class="col-md-9">
						...
						<div class="store-filter clearfix">
							<div class="store-sort">
								<label>
									Sắp xếp:
									<select class="input-select" id="product_sortBy" onchange="filterProduct('laptop')">
								...
								<label>
									Hiển thị:
									<select class="input-select" id="product_paginate" onchange="filterProduct('laptop')">
