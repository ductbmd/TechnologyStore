				...
				<div class="row">
					...
					<div class="col-md-5">
						<div class="product-details">
							...
							<div>
								<h3 class="product-price">${{$laptop->price}} <del class="product-old-price">${{$laptop->price+100}}</del></h3>
								<span class="product-available">In Stock</span>
							</div>
							<p>Đây là phần mô tả của sản phẩm.Đây là phần mô tả của sản phẩm.Đây là phần mô tả của sản phẩm.Đây là phần mô tả của sản phẩm.Đây là phần mô tả của sản phẩm.Đây là phần mô tả của sản phẩm.Đây là phần mô tả của sản phẩm.Đây là phần mô tả của sản phẩm.Đây là phần mô tả của sản phẩm.Đây là phần mô tả của sản phẩm.</p>
							...
							<div class="add-to-cart">
								...
								<button onclick="addLaptopToCart({{$laptop->id}})" class="add-to-cart-btn"><i class="fa fa-shopping-cart"></i> add to cart JS</button>
							</div>
